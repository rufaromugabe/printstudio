...
export default function Home() {
  ...
  const [embroideryDefaults,setEmbroideryDefaults]=useState<{kind:Element["embroideryKind"];spacing:number;angle:number;underlay:Element["embroideryUnderlay"]}>({kind:"auto",spacing:.45,angle:0,underlay:"auto"});
  ...
  const withEmbroideryDefaults=(el:Element):Element=>{
    ...
    return{...el,embroideryKind:embroideryDefaults.kind,embroiderySpacing:embroideryDefaults.spacing,embroideryAngle:embroideryDefaults.angle,embroideryUnderlay:embroideryDefaults.underlay};
  };
...
type MethodSettingsProps={
  ...
  embroideryDefaults:{kind:Element["embroideryKind"];spacing:number;angle:number;underlay:Element["embroideryUnderlay"]};
  setEmbroideryDefaults:(value:{kind:Element["embroideryKind"];spacing:number;angle:number;underlay:Element["embroideryUnderlay"]})=>void;
