...
export default function Home() {
  ...
  const embroideryStitchFieldMM=(()=>{
    ...
    const boxes=embroidery.document.plan.map(b=>b.bounds).filter(b=>b&&Number.isFinite(b.minX)&&Number.isFinite(b.maxX)&&Number.isFinite(b.minY)&&Number.isFinite(b.maxY));
